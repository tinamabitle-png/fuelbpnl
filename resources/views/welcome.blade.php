        ...
        <div class="max-w-4xl relative z-[1]">
            <div class="min-w-0">
                ...
                <div class="mt-5">
                    ...
                    <button
                        type="button"
                        class="bw-association-pill group relative inline-flex max-w-full bg-neutral-200 rounded-full p-px overflow-hidden"
                    ...
                    >
                        ...
                        <span class="flex items-center justify-center gap-1 relative z-[1] bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
                            <span class="relative group-hover:scale-105 transition-transform group-hover:rotate-[360deg] duration-500">
                                ...
                                >
                                    <path
                                        ...
                                        fill="url(#paint0_linear_association_welcome)"
                                        stroke="url(#paint1_linear_association_welcome)"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                    ></path>
                                    <defs>
                                        <linearGradient
                                            id="paint0_linear_association_welcome"
                                            x1="-0.5"
                                            y1="9"
                                            x2="15.5"
                                            y2="-1.5"
                                        ...
                                        <linearGradient
                                            id="paint1_linear_association_welcome"
                                            x1="-0.5"
                                            y1="9"
                                            x2="15.5"
                                            y2="-1.5"
                            ...
                            <span class="bg-gradient-to-b ml-1.5 from-neutral-950 to-neutral-950/50 bg-clip-text text-[11px] md:text-xs text-transparent group-hover:scale-105 transition transform-gpu">
