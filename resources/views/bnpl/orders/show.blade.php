...
<section class="max-w-4xl mx-auto px-6 pt-16 pb-20">
    <div class="flex items-end justify-between gap-4">
        <div>
            ...
            <h1 class="brand-font text-3xl font-semibold text-slate-900 mt-2">Order</h1>
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="glass rounded-2xl border border-slate-200 bg-white p-6">
            <p class="text-xs uppercase tracking-[0.2em] text-slate-500">Driver</p>
            <p class="text-lg font-semibold text-slate-900 mt-2">{{ $order->driver?->name ?? 'Driver' }}</p>
            <p class="text-sm text-slate-600 mt-1">{{ $order->driver?->city ?? '' }}</p>
            <div class="mt-4">
    ...
    <div class="mt-6 glass rounded-2xl border border-slate-200 bg-white p-6">
        <p class="text-sm font-semibold text-slate-900">Installments (Preview)</p>
        <p class="text-xs text-slate-500 mt-1">Payments not enabled yet.</p>
