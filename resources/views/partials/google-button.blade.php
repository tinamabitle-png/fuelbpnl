...
<a href="{{ $href }}" class="{{ $class }}">
    <svg class="mr-2 h-5 w-5" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path fill="#4CAF50" d="M24 44c5.2 0 10-2 13.5-5.3l-6.2-5.2C29.3 35 26.8 36 24 36c-5.2 0-9.6-3.3-11.2-8l-6.6 5.1C9.5 39.6 16.2 44 24 44z"/>
        <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4 5.7l.1-.1 6.2 5.2C37.2 39.1 44 34 44 24c0-1.2-.1-2.3-.4-3.5z"/>
    </svg>
    {{ $label }}
</a>
